/*
  # Add admin features and initial users
  
  1. New Tables
    - salaries: Track employee compensation
    - leaves: Manage employee leave requests
    - performance_reviews: Store employee performance data
    
  2. Security
    - Enable RLS on all new tables
    - Add admin-specific policies
    - Add user-specific viewing policies
